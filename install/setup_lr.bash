...
function install_couch_ubuntu () {
    ...
    cd "${HOME}" || {
	echo "Couldn't change to ${HOME} directory. This is very odd."
	echo "Figure out why you can't write to your own home directory and re-run this scipt!"
	echo "Exiting."
	exit 1
    }
...
function install_deps_osx () {
	...
	"Installing couchdb. This may take a while."
