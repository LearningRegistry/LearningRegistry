...
"create_timestamp": "02/12/2012",
"doc_ID":        "2350792509723209852393372450982340923209724923840923842908",
...
"filtering_keys":        ["xml", "test", "nsdl", "DC"],
...
}]}' http://localhost/publish > publish.htm && firefox publish.htm
